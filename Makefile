# kernel binary
kernel: init/loader.o memory/gdta.o interrupts/idta.o  common/generic.o devices/cpu/generic.o devices/display/generic.o devices/keyboard/generic.o devices/pit/generic.o init/main.o interrupts/idt.o memory/gdt.o
...
devices/pit/generic.c: devices/pit/interface.h interrupts/idt.h devices/display/interface.h
init/main.c: common/generic.h devices/display/interface.h devices/cpu/interface.h devices/keyboard/interface.h memory/gdt.h interrupts/idt.h devices/pit/interface.h
interrupts/idt.c: interrupts/idt.h devices/display/interface.h
memory/gdt.c: memory/gdt.h

# clean
clean:
	rm -rf kernel.bin init/loader.o common/generic.o devices/cpu/generic.o devices/display/generic.o devices/keyboard/generic.o devices/pit/generic.o init/main.o interrupts/idt.o memory/gdt.o
